...
def lvl_dos_ejecu(nombre_jugador):
    pygame.init()
    ...
    for i in range(15):
        meteoro = MeteoroDos()
        meteoro.rect.x = random.randrange(60,1140,70)
        meteoro.rect.y = random.randrange(-700,0,100)
    ...
    while running_flag:
        ...
        if personaje.hp <= 0:
            running_flag = False
            retorno =  "perdio"
            actualizar_ranking(personaje.puntuacion + 4,nombre_jugador)
